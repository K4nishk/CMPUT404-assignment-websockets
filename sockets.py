...
# # The following code is taken from the websockets example mentioned in the lecture slides
...
# --------------------------------------------------------------------------------------
# Referenced from https://github.com/abramhindle/WebSocketsExamples/blob/master/chat.py
clients = list()
...
def update(entity):
    """update the entities via this interface"""
    data_decoded = flask_post_json()
    myWorld.set(entity, data_decoded)
    return flask.jsonify(myWorld.get(entity))
